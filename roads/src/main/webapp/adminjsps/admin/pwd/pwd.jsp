...
<html>
  ...
  <body>
	...
	<div class="div1">
		<form action="<c:url value='/user/updateNameAndPass.action?uid=${uid}'/>" method="post" target="_top">
		...
		<table>
			...
			<tr>
				...
				<td><input class="input" type="loginname" name="loginname" id="loginname" value="${user.loginname }"/></td>
