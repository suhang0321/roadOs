...
<head>
    ...
    <script type="text/javascript">
        function editeItemsListSubmit() {
            document.itemsform.action="<c:url value="/zhengui/editZhenGuisSubmit.action"/>";
...
<form name="itemsform" onsubmit="return dosubmit()" method="post" action="<c:url value="/zhengui/editZhenGuisSubmit.action"/>">
<table width="100%" border=1>
    ...
    <c:forEach items="${itemsList}" var="item" varStatus="Status">
        <tr>
            <input type="hidden" name="itemsList[${Status.index}].zg_id" value="${item.zg_id}"/>
